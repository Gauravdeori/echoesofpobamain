...
const galleryImages = [
  ...
  { src: "/env-day/env-day-1.jpg", alt: "Community leaders and volunteers planting a sapling together during the World Environment Day 2026 drive.", category: "Events" },
  { src: "/env-day/env-day-2.jpg", alt: "Volunteers sweeping and cleaning streets, collecting plastic waste.", category: "Events" },
  { src: "/env-day/env-day-3.jpg", alt: "Students working together to plant a native tree sapling on World Environment Day.", category: "Events" },
  { src: "/env-day/env-day-5.jpg", alt: "A proud moment: Our large group of volunteers posing with their cleaning gear behind the event banner on World Environment Day.", category: "Events" },
